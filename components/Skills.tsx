    ...
    <div className="my-10 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      {skills.map(({ id, name, source }) => (
        <div
          ...
          className="col-span-1 p-4 gap-5 mx-2 sm:mx-6 my-2 flex flex-col items-center rounded-md dark:bg-dark bg-lighter-gray hover:scale-125 ease-out duration-300 hover:z-10"
        >
          <div>
